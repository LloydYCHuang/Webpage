...
<a href="http://pages.stat.wisc.edu/~loh/treeprogs/guide/iie.pdf" target="_blank">Visualizable and interpretable regression models with good prediction power</a> (比較各種模型效力的文章)  
